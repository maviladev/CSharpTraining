...
namespace projectoef.Migrations
{
    ...
    [Migration("20220518000217_InitialDatav2")]
            ...
            modelBuilder.Entity("projectoef.models.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("1425a7b8-1345-49ad-9755-5095f34f4aaf"),
                            CreationDate = new DateTime(2022, 5, 17, 19, 2, 17, 519, DateTimeKind.Local).AddTicks(9010),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("1425a7b8-1345-49ad-9755-5095f34f4a02"),
                            CreationDate = new DateTime(2022, 5, 17, 19, 2, 17, 519, DateTimeKind.Local).AddTicks(9060),
